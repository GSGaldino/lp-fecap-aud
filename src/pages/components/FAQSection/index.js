...
export default function FAQSection() {
  const answer2 = () => (
    <p>Para obter mais informações sobre o curso, o interessado deverá preencher o <a href="#form" style={{color: "var(--primary-color",}}>formulário</a> que se encontra no topo da página. <br></br>
    Também é possível através do número <strong>(11) 3375-0044 (Telefone)</strong> ou pelo número <strong>(11) 97121-1053 (Whatsapp).</strong> <br></br>Depois de receber o contato, o interessado poderá analisar a proposta e optar pelo ingresso. Por fim, deverá enviar seus dados pessoais para que o boleto seja gerado e possa efetuar o pagamento.</p>
  )
  const [faqs, setFaqs] = useState([
    ...
    },
    {
      ...
      answer: 'As avaliações da pós-graduação em auditoria acontecem a cada 4 meses, de forma presencial, no polo da FECAP (localizado no bairro da Liberdade) ou em um dos polos parceiros da FECAP espalhados pelo Brasil.',
      open: false
    },
    {
